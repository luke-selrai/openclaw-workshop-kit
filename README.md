...
- **Has <!-- skills-audit:total -->180<!-- /skills-audit:total --> specialist skills**, research, copywriting, sales emails, social content, competitor analysis, and more
...
3. Copy the **bootstrap prompt** and paste it into the Code session. Two ways to get it:
   - **At a facilitated workshop:** copy it from the workshop Notion page your facilitator shares.
   - **On your own, with just this repo:** open [`docs/start/bootstrap.md`](docs/start/bootstrap.md) in this kit and copy everything under the **"The Setup Prompt"** heading. That file is the same prompt, kept here as a self-serve fallback so you never need the Notion link.
