...
│   │  Uses:     <!-- skills-audit:total -->207<!-- /skills-audit:total --> Skills - specialist capabilities          │    │
...
### Skills (<!-- skills-audit:total -->207<!-- /skills-audit:total --> installed)
...
> Like giving your assistant access to <!-- skills-audit:total -->207<!-- /skills-audit:total --> specialist textbooks they can reference on demand.
...
└── claude-workshop-kit/             ← The kit setup downloaded (out of sight)
    ├── skills/                      ← Source for the <!-- skills-audit:total -->207<!-- /skills-audit:total --> skill files
