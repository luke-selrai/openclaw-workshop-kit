...
│   │  Uses:     <!-- skills-audit:total -->193<!-- /skills-audit:total --> Skills — specialist capabilities          │    │
...
### Skills (<!-- skills-audit:total -->193<!-- /skills-audit:total --> installed)
...
> Like giving your assistant access to <!-- skills-audit:total -->193<!-- /skills-audit:total --> specialist textbooks they can reference on demand.
...
│   ├── skills/                      ← Source for the <!-- skills-audit:total -->193<!-- /skills-audit:total --> skill files
