...
Optional deep-dives for when you are comfortable with day-to-day use and want to push further. **None of this is needed for the workshop itself.** Come back to this folder in month 2 or later.
...
- You want your assistant to do things while you sleep
- You want to wire automation into a workflow you already run in code
- You have outgrown the single-session flow and want longer-running jobs

If you are still getting comfortable with basic prompts, skip this folder for now and stick to [use/](../use/README.md).
