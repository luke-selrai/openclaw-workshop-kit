...
For working with real client data through the workshop-kit ecosystem, use the **Xero connector** instead (`xero-connector/XERO-SETUP.md`) — Xero allows localhost redirects in production and works out of the box with real company data.
