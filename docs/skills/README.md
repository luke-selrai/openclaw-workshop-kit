...
Your assistant has <!-- skills-audit:total -->189<!-- /skills-audit:total --> specialist skills installed. Most work immediately with no extra setup. A few need a connector (a tool that plugs your assistant into an outside service).

<!-- skills-audit:core -->23<!-- /skills-audit:core --> of them are **CORE** — the ones most business owners reach for every week. The other <!-- skills-audit:advanced -->93<!-- /skills-audit:advanced --> are **ADVANCED** (deeper work, automation, and technical integrations) plus <!-- skills-audit:dev-only -->18<!-- /skills-audit:dev-only --> **DEV-ONLY** (for attendees building web apps or infrastructure).
