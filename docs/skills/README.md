...
<!-- skills-audit:core -->24<!-- /skills-audit:core --> of them are **CORE** — the ones most business owners reach for every week. The other <!-- skills-audit:advanced -->92<!-- /skills-audit:advanced --> are **ADVANCED** (deeper work, automation, and technical integrations) plus <!-- skills-audit:dev-only -->18<!-- /skills-audit:dev-only --> **DEV-ONLY** (for attendees building web apps or infrastructure).
