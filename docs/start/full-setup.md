...
Today you are setting up a personal AI assistant that lives on YOUR computer. It learns about your business, remembers everything, and has <!-- skills-audit:total -->117<!-- /skills-audit:total --> specialist skills built in.
...
| **<!-- skills-audit:total -->117<!-- /skills-audit:total --> Skills** | Research, copywriting, sales emails, competitor analysis, and more |
...
**What happens next:** Claude will download your tools, install <!-- skills-audit:total -->117<!-- /skills-audit:total --> skills, and set up your workspace. This takes 1–2 minutes. When it is done, it will tell you to open a new folder.
...
Your assistant has <!-- skills-audit:total -->117<!-- /skills-audit:total --> specialist skills covering marketing, research, strategy, AI/automation, engineering, DevOps, and design. For the full categorised list, see [skills reference](../skills/README.md).
