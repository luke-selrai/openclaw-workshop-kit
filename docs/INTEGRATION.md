...
| **vishwa603** | Connector Recommender skill (757 lines across 3 files) — business-type-to-tools recommender with 7 business categories, curated connector stacks, MCP registry integration, 15 test cases. | [claude-workshop/connector-recommender](https://github.com/vishwa603/claude-workshop/tree/main/connector-recommender) |
