...
- **Loup path**: unchanged platform mechanics (`npx @louphq/install`, token mint, dashboard). Kit home `~/.loup/selrai-company/claude-workshop-kit`. Loup remains the workshop/commercial path and the only access-control model.
