...
- [references/replacements.md](references/replacements.md): tiered word/phrase replacement table (48 Tier 1 always-replace entries, 35 Tier 2 cluster-flag entries, 12 Tier 3 density-flag entries, 10 Tier 3 phrase entries).
- [references/categories.md](references/categories.md): 33 pattern categories with one-line description and a flagged example each.
...
### 2. Rewritten version
Apply the replacements and structural fixes. Preserve the author's facts. If the input has no facts, say so in section 3 and do not invent any.
