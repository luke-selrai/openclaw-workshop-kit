---
name: orchestrator
description: Coordinates multiple specialist skills to solve complex, multi-faceted problems. Decomposes tasks, delegates to specialists, synthesizes outputs, and creates new skills for capability gaps.
allowed-tools:
- Read
- Write
- Edit
