...
description: Shows workshop attendees all 22 core skills in plain English and gives personalised recommendations based on their onboarding answers. Use when someone asks "what can you do?", "show me the skills", "what skills do I have?", or "what should I try first?" Casual/channel triggers — "menu", "help", "what can you do", "skills", "options", "what are my options", "show me everything", "I dont know what to ask".
risk: safe
source: selrai
