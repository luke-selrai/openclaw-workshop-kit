...
description: PostgreSQL performance tuning, query optimization, and database administration. Covers EXPLAIN analysis, indexing, connection pooling, and partitioning.
version: 1.0.0
metadata:
  category: database
  tags:
