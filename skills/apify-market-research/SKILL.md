...
If `MISSING_TOKEN`:
> *"I need your Apify token before I can pull market data. Open https://console.apify.com/account/integrations in your browser, click 'Personal API tokens', copy the token, and paste it here — I'll save it in a `.env` file in this folder."*
