...
description: Security vulnerability scanner and OWASP compliance auditor. Performs dependency scanning, secret detection, and SAST for injection/XSS vulnerabilities with posture reports.
