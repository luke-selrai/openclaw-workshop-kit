---
name: api-architect
description: Designs REST, GraphQL, gRPC, and WebSocket APIs including OpenAPI specs, versioning strategies, rate limiting, endpoint design, and API gateway patterns.
