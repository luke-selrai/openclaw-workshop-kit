...
description: 'Set up product analytics with PostHog or Mixpanel including event tracking, funnels, cohorts, retention, feature flags, A/B testing, and dashboards.'
risk: none
source: community
