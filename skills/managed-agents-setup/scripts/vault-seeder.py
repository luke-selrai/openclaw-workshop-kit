...
_ap.add_argument("--client", default=os.environ.get("CLIENT_SLUG", ""))
_known, _rest = _ap.parse_known_args()
import sys; sys.argv = [sys.argv[0]] + _rest
CLIENT_SLUG = _known.client
MA_BASE = os.path.expanduser(f"~/.claude/managed-agents/{CLIENT_SLUG}" if CLIENT_SLUG else "~/.claude/managed-agents")
