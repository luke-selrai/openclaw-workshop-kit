...
description: Implements web accessibility (a11y) standards following WCAG 2.1 guidelines. Covers ARIA attributes, keyboard navigation, screen reader support, semantic HTML, and accessibility testing.
metadata:
