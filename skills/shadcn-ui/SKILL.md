---
name: shadcn-ui
description: shadcn/ui component library patterns -- installation, configuration, theming, and implementation of accessible React components with Radix UI, Tailwind CSS, React Hook Form, and Zod.
