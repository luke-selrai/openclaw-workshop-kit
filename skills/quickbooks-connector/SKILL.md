...
This connector **can** read and write all 29 QuickBooks Online entity types (invoices, customers, vendors, bills, estimates, sales receipts, credit memos, refund receipts, purchase orders, vendor credits, payments, bill payments, deposits, purchases, transfers, journal entries, items, accounts, classes, departments, terms, payment methods, time activities, employees, attachments, tax codes/rates/agencies, company info) and pull all 11 financial reports (Balance Sheet, Profit & Loss, Cash Flow, Trial Balance, General Ledger, Customer Sales, Aged Receivables [+ Detail], Customer Balance, Aged Payables, Vendor Expenses).
