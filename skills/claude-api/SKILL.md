---
name: claude-api
description: Build applications with the Claude API, Anthropic SDK, or Agent SDK. Covers Python, TypeScript, and Java SDKs with streaming, tool use, and adaptive thinking.
