...
description: "Implements passwordless-first authentication - passkeys (WebAuthn), Google and Apple sign-in, magic links, MFA and cross-device sync, often on Supabase Auth. Use when the user is adding passkeys, social login, a magic-link flow, or MFA."
allowed-tools:
- Read
- Write
- Edit
