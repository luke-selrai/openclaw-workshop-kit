...
description: Modern authentication implementation with passkeys (WebAuthn), OAuth (Google, Apple), magic links, and cross-device sync. Covers Supabase Auth, Next.js auth flows, and MFA.
allowed-tools:
- Read
- Write
- Edit
