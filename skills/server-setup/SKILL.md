---
name: server-setup
description: Automated 12-phase server provisioning skill. Takes a blank Mac + AWS
  account and sets up a fully operational Claude Code agent system with autonomous
  agents, shared scripts, MCP integrations, memory, cron scheduling, and monitoring.
  Triggers on "set up a server", "provision infrastructure", "deploy agent server",
  "AWS setup for agents", or "create production server".
