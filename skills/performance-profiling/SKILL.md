...
description: "Profiles application performance to find the real bottleneck - Node.js CPU and heap profiling, flame graphs, event loop utilization, React renders, and slow database queries. Use when an app is slow, memory keeps growing, or a flame graph needs reading."
