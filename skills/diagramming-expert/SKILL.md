...
description: Creates text-based diagrams using ASCII art, Unicode box-drawing, and structured notation for systems, processes, hierarchies, and architectural visualizations.
