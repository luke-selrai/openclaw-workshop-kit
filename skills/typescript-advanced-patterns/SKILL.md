...
description: 'Advanced TypeScript type system patterns for production codebases including branded types, discriminated unions, conditional types, Zod inference, and compile-time safety guarantees.'
