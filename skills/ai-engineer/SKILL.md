---
name: ai-engineer
description: Builds production-ready LLM applications, RAG systems, and intelligent agents. Implements vector search, multimodal AI, agent orchestration, and enterprise AI integrations.
